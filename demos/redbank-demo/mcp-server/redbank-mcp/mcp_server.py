...
def validate_date(date_str: str, param_name: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"{param_name} must be in YYYY-MM-DD format (e.g., 2025-01-15), got: {date_str}")
...
@mcp.tool()
@handle_db_errors
def get_customer(email: Optional[str] = None, phone: Optional[str] = None) -> Dict[str, Any]:
...
def search_transactions(
    ...
    """
    logger.info(f"Searching transactions with filters")
